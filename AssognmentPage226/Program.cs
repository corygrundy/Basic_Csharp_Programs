...
namespace AssognmentPage226
{
    class Program
    {
        ...
        {    //Begin part 2
            ...
            //Begin part 6
            Console.WriteLine("Enter a Number to be converted into astring and then add the number 5 to it.");
            string ui3 = Console.ReadLine();
            //string result3 = Convert.ToString(Class1.MethodAdd1(ui3)); 
            int result3 = Class1.Method1(ui3);
            Console.WriteLine("Your string with the added number of 5 reads, " + result3);
            Console.ReadLine();
        }
    }
}